 ...
 * 
 */
@WebServiceClient(name = "ProductEndpointService", targetNamespace = "http://endpoints.SpringWebService.erkan.com/", wsdlLocation = "https://springbootjaxws.herokuapp.com/ws/ProductWebServices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTENDPOINTSERVICE_QNAME = new QName("http://endpoints.SpringWebService.erkan.com/", "ProductEndpointService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://springbootjaxws.herokuapp.com/ws/ProductWebServices?wsdl");
    ...
    public ProductEndpoint getProductEndpointPort() {
        return super.getPort(new QName("http://endpoints.SpringWebService.erkan.com/", "ProductEndpointPort"), ProductEndpoint.class);
    }
    ...
    public ProductEndpoint getProductEndpointPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoints.SpringWebService.erkan.com/", "ProductEndpointPort"), ProductEndpoint.class, features);
    }
