 ...
 * generated in the com.erkan.springwebservice.endpoints package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetProducts_QNAME = new QName("http://endpoints.SpringWebService.erkan.com/", "getProducts");
    private final static QName _GetProductsResponse_QNAME = new QName("http://endpoints.SpringWebService.erkan.com/", "getProductsResponse");
    private final static QName _GetProduct_QNAME = new QName("http://endpoints.SpringWebService.erkan.com/", "getProduct");
    private final static QName _GetProductResponse_QNAME = new QName("http://endpoints.SpringWebService.erkan.com/", "getProductResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.erkan.springwebservice.endpoints
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoints.SpringWebService.erkan.com/", name = "getProducts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoints.SpringWebService.erkan.com/", name = "getProductsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoints.SpringWebService.erkan.com/", name = "getProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://endpoints.SpringWebService.erkan.com/", name = "getProductResponse")
